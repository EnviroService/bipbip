 ...
 */
final class Version20191210145436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, organisms_id_id INT DEFAULT NULL, gender VARCHAR(5) NOT NULL, lastname VARCHAR(45) NOT NULL, firstname VARCHAR(45) NOT NULL, mail VARCHAR(45) NOT NULL, password VARCHAR(255) NOT NULL, postcode INT NOT NULL, city VARCHAR(45) NOT NULL, phone INT NOT NULL, signup_date DATETIME NOT NULL, signin_last DATE NOT NULL, status VARCHAR(10) NOT NULL, INDEX IDX_1483A5E93EBDCF30 (organisms_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE estimations (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, estimation_date DATETIME NOT NULL, is_collected TINYINT(1) NOT NULL, model VARCHAR(45) NOT NULL, capacity INT NOT NULL, brand VARCHAR(45) NOT NULL, color VARCHAR(45) NOT NULL, liquid_damage INT NOT NULL, screen_cracks INT NOT NULL, casing_cracks INT NOT NULL, battery_cracks INT NOT NULL, button_cracks INT NOT NULL, max_price INT NOT NULL, estimated_price INT NOT NULL, is_validated_payment TINYINT(1) NOT NULL, is_validated_signature TINYINT(1) NOT NULL, INDEX IDX_27DD79AA9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE collects (id INT AUTO_INCREMENT NOT NULL, organisms_id INT NOT NULL, date_collect DATETIME NOT NULL, INDEX IDX_A17AFF6C28AF30B6 (organisms_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
